    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
      <div>
        <h4 class="fw-bold mb-1 text-primary" style="color: #2b3445">
          <i class="fa-solid fa-chalkboard-user"></i> Quản Lý Bài Học
        </h4>
      ...
      <div class="col-lg-4 col-md-5">
        ...
        >
          ...
          <div class="card-body p-3">
            <div class="mb-3">
              <input
                v-model.trim="bo_loc_danh_muc.tim_kiem"
                type="text"
              ...
              <div class="form-check mt-2 mb-0">
                <input
                  id="chiCoDanhMucCoBai"
                  class="form-check-input"
                  type="checkbox"
                  v-model="bo_loc_danh_muc.chi_co_bai"
                  @change="locDanhMuc"
                />
                <label
                  class="form-check-label small text-muted"
                  for="chiCoDanhMucCoBai"
                >
            ...
            <div
              v-else-if="danh_muc_hien_thi.length === 0"
      ...
      <div class="col-lg-8 col-md-7">
        ...
        >
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <div
              v-else-if="!danh_muc_dang_chon && danh_muc.length > 0"
            ...
            >
              ...
              >
                <i
                  class="fa-solid fa-arrow-pointer fs-2 text-secondary opacity-50"
                ></i>
              </div>
              <h6 class="text-muted fw-medium">
                Vui lòng chọn một danh mục bên trái để xem.
              </h6>
            </div>

            <div
              v-else-if="bai_hoc_hien_thi.length === 0"
            ...
            >
              ...
              >
                <i
                  class="fa-regular fa-folder-open fs-2"
                  style="color: #667eea"
                ></i>
              </div>
              <h5 class="fw-bold text-dark mb-2">Chưa có bài học nào</h5>
              <p class="text-muted mb-4 small">
                Danh mục này hiện đang trống. Hãy tạo nội dung đầu tiên nhé!
              </p>
              <button
            ...
            <div class="row g-4" v-else>
              <div
                ...
                v-for="bai in bai_hoc_hien_thi"
                :key="bai.id"
              >
                <div
                  class="card h-100 border-0 shadow-sm rounded-4"
                  style="
                    cursor: pointer;
                  ...
                  onmouseover="
                    ...
                    this.classList.replace('shadow-sm', 'shadow');
                    this.style.borderColor = '#e2e8f0';
                  "
                  onmouseout="
                    this.style.transform = 'translateY(0)';
                    this.classList.replace('shadow', 'shadow-sm');
                ...
                >
                  <div class="card-body p-4">
                    <div class="d-flex align-items-start gap-3">
                      ...
                      >
                        <i
                          :class="[bai.icon || 'fa-solid fa-book', 'fs-3']"
                          :style="`color: ${bai.mau_icon || '#16a34a'};`"
                        ></i>
                      </div>
                      ...
                      <div class="flex-grow-1" style="min-width: 0">
                        ...
                        >
                          <h6
                            class="fw-bold text-truncate mb-0 pe-2 fs-6 text-dark"
                            :title="bai.tieu_de"
                            ...
                            >
                              <li>
                                <a
                                  ...
                                  data-bs-toggle="modal"
                                  data-bs-target="#baiHocModal"
                                  @click.stop.prevent="suaBaiHoc(bai)"
                                  ><i
                              ...
                              <li>
                                <a
                                  class="dropdown-item py-2 fw-medium"
                                  href="#"
                                  @click.stop.prevent="quanLyTuVung(bai)"
                                  ><i
          ...
          <div class="modal-body p-4">
            <div class="mb-3">
              <label class="form-label fw-medium"
                >Thuộc danh mục <span class="text-danger">*</span></label
              >
            ...
            <div class="mb-3">
              <label class="form-label fw-medium"
                >Tiêu đề bài học <span class="text-danger">*</span></label
              >
              <input
                type="text"
                class="form-control"
                v-model="formBaiHoc.tieu_de"
                placeholder="VD: Phân biệt Âm L và N"
                required
              />
            </div>
            ...
            <div class="mb-3">
              ...
              <textarea
                class="form-control"
                v-model="formBaiHoc.mo_ta"
                rows="2"
                placeholder="Ghi chú ngắn về bài học..."
              ></textarea>
            </div>
          ...
          <div class="modal-body p-4">
            <div class="mb-3">
              ...
              <input
                type="text"
                class="form-control"
                v-model="formDanhMuc.ten"
                placeholder="VD: Luyện âm cơ bản"
                required
              />
            </div>
            <div class="mb-3">
              <label class="form-label fw-medium"
                >Icon minh họa (Class FontAwesome)</label
              >
              <input
                type="text"
                class="form-control"
                v-model="formDanhMuc.icon"
                placeholder="VD: fa-solid fa-lips"
              />
              <div class="mt-2 text-muted small">
                <i :class="formDanhMuc.icon || 'fa-solid fa-folder'"></i> Xem
                trước Icon
              </div>
            </div>
          </div>
          ...
          <div class="modal-body text-center p-4">
            ...
            <p class="text-muted mb-4">
              ...
              <strong class="text-danger">{{
                doiTuongXoa?.ten || doiTuongXoa?.tieu_de
              }}</strong>
...
export default {
  ...
  computed: {
    ...
    bai_hoc_hien_thi() {
      ...
      return this.bai_hoc.filter(
        (bai) => bai.danh_muc_id === this.danh_muc_dang_chon,
      );
    },
    tenDanhMucDangChon() {
  ...
  methods: {
    handleBaiHocDuyet(e) {
      const data = e.detail;
      const baiHocIndex = this.bai_hoc.findIndex(
        (b) => b.id === data.bai_hoc_id,
      );
      if (baiHocIndex !== -1) {
    ...
    taiDanhMuc(preferredDanhMucId = null) {
      ...
      axios
        .get(this.apiBase + "/api/teacher/danh-muc-bai-hoc", {
        ...
        .then((res) => {
          if (res.data.status) {
            ...
            if (
              ...
              const vanTonTai = this.danh_muc.some(
